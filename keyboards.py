...
def product_detail_kb(lang: str, product_id: int, price: float, in_stock: bool) -> InlineKeyboardMarkup:
    ...
    if in_stock:
        builder.row(
            InlineKeyboardButton(text=t(lang, "btn_buy_1", price=f"{price:.2f}"), callback_data=f"buy:{product_id}:1")
        )
        builder.row(
            InlineKeyboardButton(text=t(lang, "btn_buy_3", price=f"{price*3:.2f}"), callback_data=f"buy:{product_id}:3"),
            InlineKeyboardButton(text=t(lang, "btn_buy_5", price=f"{price*5:.2f}"), callback_data=f"buy:{product_id}:5"),
        )
        builder.row(
            InlineKeyboardButton(text=t(lang, "btn_buy_10", price=f"{price*10:.2f}"), callback_data=f"buy:{product_id}:10"),
            InlineKeyboardButton(text=t(lang, "btn_custom_qty"), callback_data=f"buy:{product_id}:custom"),
        )
    builder.row(InlineKeyboardButton(text=t(lang, "btn_back"), callback_data="shop"))
    return builder.as_markup()


# ─────────────────────────────────────────────────────────────────────────────
# Shop (simple single-product)
# ─────────────────────────────────────────────────────────────────────────────
...
def shop_kb(lang: str = "en", price: float = 4.99, in_stock: bool = True, mini_app_url: str = "") -> InlineKeyboardMarkup:
    ...
    if in_stock:
        builder.row(
            InlineKeyboardButton(text=t(lang, "btn_buy_1", price=f"{price:.2f}"), callback_data="buy:1")
        )
        builder.row(
            InlineKeyboardButton(text=t(lang, "btn_buy_3", price=f"{price*3:.2f}"), callback_data="buy:3"),
            InlineKeyboardButton(text=t(lang, "btn_buy_5", price=f"{price*5:.2f}"), callback_data="buy:5"),
        )
        builder.row(
            InlineKeyboardButton(text=t(lang, "btn_buy_10", price=f"{price*10:.2f}"), callback_data="buy:10"),
            InlineKeyboardButton(text=t(lang, "btn_custom_qty"), callback_data="buy:custom"),
        )
    builder.row(InlineKeyboardButton(text=t(lang, "btn_back"), callback_data="main_menu"))
    return builder.as_markup()
