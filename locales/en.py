...
STRINGS = {
    ...
    "product_card": (
        f"{E_ROBOT} <b>{{name}}</b>\n\n"
        f"{E_MONEY} <b>Price:</b>  <code>${{price}}</code> per code\n"
        f"{E_CHART} <b>Sold:</b>   <code>{{sold}}+</code> codes\n"
        f"{E_PACKAGE} <b>Stock:</b>  <code>{{stock}}</code> available\n"
        f"{E_STAR} <b>Rating:</b> {{rating}} ({{review_count}} reviews)\n\n"
        "🏷️ <b>Bulk Discounts:</b>\n"
        "  50–99 codes → <code>$0.57</code> each\n"
        "  100–199 codes → <code>$0.52</code> each\n"
        "  200+ codes → <code>$0.49</code> each\n\n"
        "<blockquote>"
        "🤖 <b>Gemini AI Pro — 18 Months Plan</b>\n\n"
        "✅ 5TB cloud storage included\n"
        "✅ Add up to 5 users\n"
        "✅ 100% Private — Not Shared\n"
        "✅ No card needed\n"
        "✅ Works in any country — no verification\n"
        "✅ Full Family Account (NOT an invite)\n"
        "✅ 100% genuine — activated on your Gmail\n\n"
        "⚠️ <b>Non Warranty</b>\n\n"
        "📌 Paste the link in browser → click <b>\"Activate Offer\"</b>\n\n"
        "⏰ Use within 24h. Report issues within 24h.\n"
        "No replacement after 24 hours.\n\n"
        "⚡ Delivery automatic after payment."
        "</blockquote>\n\n"
        "━━━━━━━━━━━━━━━━━━━━━━━━━\n"
    ...
    "terms": (
        ...
        f"{E_CHECK} Warranty is <b>strictly for the purchased items</b> — valid <b>24 hours only</b> from delivery.\n\n"
        f"{E_KEY} Covers <b>activation only</b>, not subscription duration after redemption.\n\n"
