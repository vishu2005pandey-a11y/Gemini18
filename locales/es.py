...
STRINGS = {
    ...
    "product_card": (
        f"{E_ROBOT} <b>{{name}}</b>\n\n"
        f"{E_MONEY} <b>Precio:</b>  <code>${{price}}</code> por código\n"
        f"{E_CHART} <b>Vendido:</b> <code>{{sold}}+</code> códigos\n"
        f"{E_PACKAGE} <b>Stock:</b>   <code>{{stock}}</code> disponibles\n"
        f"{E_STAR} <b>Rating:</b> {{rating}} ({{review_count}} reseñas)\n\n"
        "🏷️ <b>Descuentos por volumen:</b>\n"
        "  50–99 códigos → <code>$0.57</code> c/u\n"
        "  100–199 códigos → <code>$0.52</code> c/u\n"
        "  200+ códigos → <code>$0.49</code> c/u\n\n"
        "<blockquote>"
        "🤖 <b>Gemini AI Pro — Plan 18 Meses</b>\n\n"
        "✅ 5TB almacenamiento incluido\n"
        "✅ Hasta 5 usuarios\n"
        "✅ 100% Privado — No compartido\n"
        "✅ Sin tarjeta necesaria\n"
        "✅ Funciona en cualquier país\n"
        "✅ Cuenta Familiar completa (NO es invitación)\n"
        "✅ 100% genuino — activado en tu Gmail\n\n"
        "⚠️ <b>Sin garantía</b>\n\n"
        "📌 Pega el enlace en el navegador → clic en <b>\"Activate Offer\"</b>\n\n"
        "⏰ Usa dentro de 24h. Reporta problemas en 24h.\n"
        "Sin reemplazo después de 24 horas.\n\n"
        "⚡ Entrega automática tras confirmación de pago."
        "</blockquote>\n\n"
        "━━━━━━━━━━━━━━━━━━━━━━━━━\n"
